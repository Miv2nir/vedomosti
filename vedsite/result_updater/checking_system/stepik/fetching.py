...
#        return paths
    ...
    def stepik_json(self, stepik_data):
    ...
    def _fetch_contest_results(self, task_id):
        ...
        uri_json = requests.get(uri, headers=headers).json()
        ...
        for step in all_steps:
            ...
            while True:
                s_json = requests.get(urls, headers=headers).json()
            ...
            a_json = requests.get(urla_json, headers=headers).json()
            ...
            u_json = requests.get(urla_json, headers=headers).json()
