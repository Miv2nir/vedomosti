...
urlpatterns = [
    ...
    path('work/<uuid:d_id>/<int:g_number>/update/', views.table_update, name='table_update'),
    path('work/<uuid:d_id>/<int:g_number>/download/', views.table_download, name='table_download'),
    path('work/<uuid:d_id>/<int:g_number>/upload/', views.table_upload, name='table_upload'),
    ...
    path('credentials/about/', views.credentials_about, name='credentials_about')
]
